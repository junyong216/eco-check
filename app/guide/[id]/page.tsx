...
const guideContents: Record<string, { title: string; tag: string; content: string[] }> = {
  "1": { title: "고금리 시대의 자산 배분 전략", tag: "Strategy", content: [
  ...
  "2": { title: "시장의 심리, 공포와 탐욕 지수", tag: "Psychology", content: [
  ...
  "3": { title: "분산 투자의 기술: 포트폴리오 최적화", tag: "Risk", content: [
  ...
  "4": { title: "워렌 버핏의 가치투자 철학", tag: "Legend", content: [
  ...
  "5": { title: "세계 금융의 심장, '월가' 완벽 이해하기", tag: "Finance", content: [
  ...
  "6": { title: "제2의 월급, 배당주 투자의 기초", tag: "Income", content: [
